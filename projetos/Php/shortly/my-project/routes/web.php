...
// pages that require auth with passwords
...
// user related pages, user links and link creation
...
// api
Route::get('/api/{token}', [apiController::class, 'handleToken']);
// link redirection
